...
Object.defineProperty(exports, "__esModule", { value: true });
const handleEvent_1 = __importDefault(__webpack_require__(644));
function handle(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield handleEvent_1.default(context);
            res.send('ok');
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const slack_1 = __importDefault(__webpack_require__(777));
...
function handleCommentEvent(payload) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const recipients = [prAuthor, ...payload.pull_request.assignees].filter(user => user.login !== commentAuthor.login);
...
const config_1 = __importDefault(__webpack_require__(641));
function sendMessages(messages) {
    return __awaiter(this, void 0, void 0, function* () {
        const { users, slackToken } = yield config_1.default();
